...
PIXELA_TOKEN = "830AM322022"
PIXELA_USERNAME = "murphy"
...
def create_graph():
    graph_url = f"{PIXELA_API_URL}/{PIXELA_USERNAME}/graphs"
...
def add_value(quantity):
    ...
    graph_url = f"{PIXELA_API_URL}/{PIXELA_USERNAME}/graphs/graph1"
...
def update_value(date, quantity):
    value_url = f"{PIXELA_API_URL}/{PIXELA_USERNAME}/graphs/graph1/{date}"
