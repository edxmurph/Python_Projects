...
# left column
start_btn = tk.Button(text="Start", bg=GREEN, font=(FONT_NAME, 11), width=6, relief="groove", command=start)
start_btn.grid(row=2, column=0, padx=20)

# middle column
timer_label = tk.Label(text="Timer", fg=GREEN, bg=YELLOW, font=(FONT_NAME, 36, "bold"))
...
# right column
reset_btn = tk.Button(text="Reset", bg=PINK, font=(FONT_NAME, 11), width=6, relief="groove", command=reset)
